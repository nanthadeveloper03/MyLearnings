            ...
            <div className="rew_tabsc mt-4">
                ...
                <div className="row filt_histrw1">
                    ...
                    <div className="col-md-4 reduce-gap mt-4 p-1">
                        ...
                        <button className="btn btn-action    primaryClr text-white float-end mx-4" onClick={downloadExcel}>Download Excel</button>
                    </div>

                </div>

                <div className="table-responsive text-center hist_table cm_table1 mt-3">
                    <DataTable
                        columns={columns}
                        data={withdrawData}
                        striped={true}
