      ...
      <div className='trd_hdsc1 w-100'>
        <div className='trd_hdlef1 d-flex align-items-center'>
          <div className='trd_bal1'>
            <h4>
              ...
              <div className='coin_tnam'>
                <div className='coin_thd'>{(pairInfo.fromCurrency) ? pairInfo.fromCurrency : "..."}/{(pairInfo.toCurrency) ? pairInfo.toCurrency : "..."} <span className='coin_tim'>3X</span> </div>
          ...
          <div className='trd_bal2' style={{width:"10%"}}>
            <h5 className='pri_color'>{tickerData && decimalRoundOff((tickerData.c * inrPrice), priceDecimal) || '0.0000'}</h5>
            {/*<h6>$59480.93</h6>*/}
          </div>
          ...
          <ul className="d-flex flex-wrap gap-5 trd_vlis1">
            ...
            {/* <li>
              ...
              <p>
                {pairInfo.priceVolume ? formatNumberKMB(pairInfo.priceVolume, pairInfo.priceDecimal) : "..."}
              </p>
            </li> */}
          </ul>
        </div>
