...
const StakingPlan = ({ balance, onSuccess, maintanenceProp }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(postForm, 'postFormpostForm');
      ...
      <section className='plan_sc1' id="planSection">
        ...
        <div className='row d-flex justify-content-center align-items-center'>
          ...
          <ul className="menu-stk d-flex justify-content-evenly">
                <li className={flatTabs === 1 ? "active" : ""} onClick={() => handleFlatTabs(1)}><Link href="#">Flexible Staking</Link></li>
                <li className={flatTabs === 2 ? "active" : ""} onClick={() => handleFlatTabs(2)}><Link href="#">Airdrop Staking</Link></li>
              </ul>
...
<div className="content-tabo">
  <div className="content-inner" style={{ display: `${flatTabs === 1 ? "block" : "none"}` }}>
        ...
        <StakingFlexible balance={balance} onHit={openModal} currentPrice={currentPrice.oneCoinPrice}/>
        </div>
