                    ...
                    <div className="cm_faq1">
                        <div className="flat-accordion">
                            ...
                            <div className={isActive == 4 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleClick(4)}>
                                <h6 className="toggle-title finter fw600 black8">How do I claim my USDT reward?
                                </h6>
                                <div className="toggle-content" style={{ display: `${isActive == 4 ? "block" : "none"}` }}>
                                    <p>
                                    After your friends complete their staking using your voucher code, you can claim your USDT reward directly from your account.   
                                    </p>
                                </div>
                            </div>
