...
const SocReward = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    // Append files directly instead of URLs
    // for (const [key, value] of Object.entries(images)) {
    //   formData.append(key, value.file); // Use the file reference
    // }
    const formData = new FormData();
            ...
            <div className="col-md-12">
              <ul className="step_bc1">
                ...
                <li>
                  ...
                  <p className="fopsans fw400">
                    This 2 USDT will be added to your Rewards Assets.
                  </p>
                </li>
                <li>
                  <div className="stp_ico d-flex justify-content-center align-items-center">
              ...
              <div className="vote_bk1">
                <div className="vote_imp">
                  ...
                  <span className="vot_imrig">
                    {/* {isAuthenticated 
                    ? <>
                    {statusData === 0 && <span>Pending</span>}
                    {statusData === 1 && <span>Verified</span>}
                    {statusData !== 0 || statusData !== 1 ? (
                     
                        <button
                        type="button"
                        className="btn btn-action text-white fopsans fw600"
                        disabled={ShowClickBtn}
                        onClick={openModal}
                      >
                        Click Here
                      </button>
                    ...
                    :<button type="button" className="btn btn-action text-white fopsans fw600" onClick={()=>router.push('/login')}>Login</button>
                  } */}
            ...
            <div className="form-group">
              ...
              {!selectedApp && (
                <p className="text-danger">
                  Please select a social media app before uploading.
                </p>
              )}
