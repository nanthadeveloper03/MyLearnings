...
const TradeFooter = () => {
  ...
  return (
    <>
      <div className='trd_footsc2 p-3 w-100'>
            ...
            <div className="content-inner" style={{ display: `${flatTabs === 1 ? "block" : "none"}` }}>
              ...
              <div className="content-inner" style={{ display: `${flatTabs1 === 1 ? "block" : "none"}` }}>
                ...
                <form className='trd_form1'>
                  ...
                  <div className='form-group'>
                    <button type='button' className='btn btn-action text-white w-100' onClick={buyclick}>Log In</button>
                  </div>
                </form>
              </div>
