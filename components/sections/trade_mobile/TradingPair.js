...
const TradingPair = () => {
  ...
  const handleSearchChange = (e) => {
    ...
    const filteredData = coins1.filter((item) =>
      item.name1.toLowerCase().includes(value)
    );
      ...
      <div className='market_tsc4'>
        ...
        <div className='search_area1'>
          <div className='input-group cm_tinpgrp2 flex-nowrap'>
            ...
            <input type='text' className='form-control' placeholder='Search' value={searchQuery} onChange={handleSearchChange} onBlur={() => {
          ...
          <div className='search_leave'>
            ...
            <div className='coinpairsc'>
              <div className='sort_hd d-flex align-items-center w-100'>
                ...
                <div className='sfd2 d-inline-flex justify-content-end align-items-center'>
              ...
              <div className='sort_body d-flex flex-column w-100'>
                {filteredCoins.length > 0 ? ( 
                  filteredCoins.map((coin, index) => (
                    <a key={index} href={`/trade/?pair=${coin.pair}`}>
