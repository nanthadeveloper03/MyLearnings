...
const TradeFooter = ({ pairInfo, pairBalancefrom }) => {
    ...
    <>
      ...
      <div className={`offcanvas buysell_canvas ${isOpen ? 'show' : ''}`}>
        <div className="offcanvasContent">
          {/* <button className="closeButton" onClick={toggleOffcanvas}>
            &times; 
          </button> */}
                  ...
                  <form className='trd_form1'>
                    <div className='form-group'>
                      <div className='input-group cm_tinpgrp1 flex-nowrap'>
                        ...
                        <input value={pricebuyLimit} type='text' className='form-control' placeholder='' onKeyDown={handleKeyDown} onChange={(e) => buylimitamountpricechange(e.target.value, 'price')} />
                  ...
                  <form className='trd_form1'>
                    ...
                    <div className='form-group'>
                      <div className='input-group cm_tinpgrp1 flex-nowrap'>
                        ...
                        <input type='text' className='form-control' value={totalbuyMarket} onChange={(e) => changeMarkettotalbuy(e)} placeholder='' />
                        <span className='input-group-text'>
                          {(pairInfo.toCurrency) ? pairInfo.toCurrency : "..."}
                        </span>
                      </div>
                  ...
                  <form className='trd_form1'>
                    ...
                    <div className='form-group'>
                      <div className='input-group cm_tinpgrp1 flex-nowrap'>
                        ...
                        <input type='text' className='form-control' onKeyDown={handleKeyDown} value={totalsellMarket} onChange={(e) => changeMarkettotalsell(e)} placeholder='' />
                        <span className='input-group-text'>
                          {(pairInfo.toCurrency) ? pairInfo.toCurrency : "..."}
                        </span>
                      </div>
