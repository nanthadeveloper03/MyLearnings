              ...
              <div className="com_midhd rsp_w100">
                <div className='cm_inthd2 text-center'>
                  <h3 className='finter fw600 text-white text-capitalize'>
                    Follow Our <span className='pri_color'>6 Official Social Media</span> Accounts, Leave a Review on <span className='pri_color'>Trustpilot</span>, and Claim <span className='pri_color'>2 USDT!</span>
                  </h3>
                </div>
              </div>
