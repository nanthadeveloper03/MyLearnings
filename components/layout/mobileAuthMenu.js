...
export default function MainMenu({ isMobileMenu }) {
    ...
    // Optional: Automatically open the accordion if a nested route is active
  useEffect(() => {
    if (
      pathname.startsWith('/profile/') ||
      pathname.startsWith('/kyc-verification/kyc/')
    ...
    if (
      pathname.startsWith('/spotassets/') ||
    ...
    return (
        <>
            <ul id="menu-primary-menu" className="menu aft_login_menu mt-3">

                <li className={`menu-item ${pathname === "/dashboard/" ? "current-menu-item" : ""}`}>
                    <Link href="/dashboard">
                        <svg
                            width="20"
                            height="20"
                ...
                <li className="menu-item">
                    <div
                        ...
                        className={`collapse_menu ${openAccount ? 'active' : ''}`}
                    >
                        <span className='mn_menutxaft'>
                            <svg
                                width="14"
                                height="14"
                                viewBox="0 0 14 14"
                    ...
                    <Collapse in={openAccount}>
                        <ul id="account-collapse">                        
                            <li className={`menu-item ${(pathname == '/profile/') ? 'current-menu-item' : ''}`}>
                             <Link href="/profile/">User Profile</Link>
                            </li>
                            <li className={`menu-item ${(pathname == '/kyc-verification/kyc/') ? 'current-menu-item' : ''}`}>
                                <Link href="/kyc-verification/kyc/">Identity Verification</Link>
                            </li>
                            {/* <li>
                ...
                {/* <li className={`sidebar-menu-item ${openOrders ? "expanded" : ""}`}>
                    <div
                    ...
                    >
                        <span className='mn_menutxaft'>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g clipPath="url(#clip0_905_17195)">
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                    ...
                    <Collapse in={openOrders}>
                        <ul id="orders-collapse">
                            <li>
                                <Link href="/order/">Spot</Link>
                            </li>
                            <li>
                                <Link href="/soon_order_history/">Staking</Link>
                            </li>
                        </ul>
                    </Collapse>
                </li> */}

                <li className={`sidebar-menu-item ${openAssets ? "expanded" : ""}`}>
                    <div
                        onClick={() => setOpenAssets(!openAssets)}
                        aria-controls="assets-collapse"
                        aria-expanded={openAssets}
                        className={`collapse_menu ${openAssets ? 'active' : ''}`}
                    >
                        <span className='mn_menutxaft'>
                            <img src='/assets/images/dash_ico/wallet1.png' className='img-fluid' />
                            Assets
                        </span>
                        <span className='expander'>
                            <svg
                    ...
                    <Collapse in={openAssets}>
                        <ul id="assets-collapse">
                            <li className={`menu-item ${(pathname == '/spotassets/') ? 'current-menu-item' : ''}`}>
                                <Link href="/spotassets/">Spot</Link>
                            </li>
                            <li className={`menu-item ${(pathname == '/rewards/') ? 'current-menu-item' : ''}`}>
                                <Link href="/rewards/">Rewards</Link>
                            </li>
                            <li className={`menu-item ${(pathname == '/referral/') ? 'current-menu-item' : ''}`}>
                ...
                {/* <li className={`menu-item ${pathname === "/account" ? "current-menu-item" : ""}`}>
                    <Link href="/soon_profile/" className='mob_drp1'> Account </Link>
                </li>

                <ul className='mob_submn1'>
                <li>
                <Link href="/soon_profile">Profile</Link>
              </li>
              <li>
                <Link href="/soon_settings">Settings</Link>
              </li>               
              </ul>


                <li className={`menu-item ${pathname === "/soon_order/" ? "current-menu-item" : ""}`}>
                    <Link href="/soon_order/"> Orders </Link>
                </li>

                <li>
                <Link href="/soon_order/">Current Orders</Link>
              </li>
              <li>
                <Link href="/soon_order_history/">Order History</Link>
              </li> */}
                ...
                <li className={`menuitem ${(pathname == '/stakinghistory/') ? 'active' : ''}`}>
                    <Link href="/stakinghistory/">
                    <img src='/assets/images/dash_ico/stake_portfolio.png' className='img-fluid' />
                        Stake Portfolio
                    </Link>
                    </li>

                <li className={`menu-item ${pathname === "/rewardshub/" ? "current-menu-item" : ""}`}>
                    <Link href="/rewardshub/">
                        <svg
                            width="20"
                            height="20"
                            viewBox="0 0 20 20"
                ...
                <li className={`menu-item ${pathname === "/deposit/" ? "current-menu-item" : ""}`}>
                    <Link href="/deposit/">
                        <img src="/assets/images/dash_ico/Wallet.png" className="img-fluid" />
                        Deposit
                    </Link>
                </li>

                <li className={`menu-item ${pathname === "/withdraw/" ? "current-menu-item" : ""}`}>
                    <Link href="/withdraw/">
                        <img src="/assets/images/dash_ico/withdraw.png" className="img-fluid" />
                        Withdraw
                    </Link>
                </li>

                <li className={`menu-item ${pathname === "/history/" ? "current-menu-item" : ""}`}>
                    <Link href="/history/">
                        <img src="/assets/images/dash_ico/history.png" className="img-fluid" />
                        History
                    </Link>
                </li>

                {/* <li className={`menu-item ${pathname === "/soon_settings/" ? "current-menu-item" : ""}`}>
                    <Link href="/soon_settings/">
                        <svg
                            width="20"
                            height="20"
                            viewBox="0 0 20 20"
                ...
                {isMobileMenu && isAuthenticated &&
                    ...
                    <div className='header sign_hd mt-3'>
                        <div className='header__right d-flex justify-content-center'>
                            ...
                            <div className="wallet custom-wallet fill w-100 m-0" onClick={handleLogout}>
