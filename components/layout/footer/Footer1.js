      ...
      <footer className="footer">
        <div className="container">
          <div className="footer__main custom__footer">
            <div className="row rsp_mma5">
              <div className="col-xl-3 col-md-4 rsp_mpd5">
                <div className="info">
              ...
              <div className="col-xl-9 col-md-8 rsp_mpd5">
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        ...
                        <li><Link href="/riskdisclosure">Risk Disclosures</Link></li>
                        {/* <li><Link href="/refundpolicy">Refund policy</Link></li> */}
                        <li><Link href="/amlpolicy">AML policy</Link></li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        <li><Link href="/soon_tradeloan">Trade Loan</Link></li>
                        <li><Link href="/soon_copytrading">Copy Trading</Link></li>
                        <li><Link href="/staking">Staking</Link></li>
                        <li><Link href="/soon_lending">Lending</Link></li>
                        <li><Link href="/claim-25-usdt">USDT Bonanza</Link></li>
                        <li><Link href="/soon_arbitragesignal">Arbitrage Signal</Link></li>
                        <li><Link href="/soon_crosscoinwithdraw">Cross Coin Withdraw</Link></li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        ...
                        <li><Link href="/soon_howitworks">How its works</Link></li>
                  ...
                  <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        ...
                        <li><Link href="/conmetamask">Connect MetaMask to UPRO</Link></li>
                ...
                <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        <li><Link href="/trade">Spot Trading</Link></li>
                        <li><Link href="/soon_trading_margin">Margin Trading</Link></li>
                        <li><Link href="/soon_convert">Convert</Link></li>
                        <li><Link href="/soon_swap">Swap</Link></li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-xl-3 col-md-6 col-sm-6 col-6 rsp_mpd5">
                    <div className="widget-link s1">
                      ...
                      <ul>
                        <li><Link href={process.env.NEXT_PUBLIC_APK_URL} target="_blank">Download for Andriod</Link></li>
                        <li><Link href='#' title="coming soon" className="fwdfoot">Download for IOS <span className="badge1">Coming soon</span></Link></li>
                        <li><Link href='#' title="coming soon" className="fwdfoot1">Download for Windows <span className="badge1">Coming soon</span></Link></li>
                      </ul>
                    </div>
                  </div>
                </div>
