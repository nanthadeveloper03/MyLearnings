      ...
      {pairInfo.pair.includes("UPRO") == true &&
         <div className='trd_hdsc1 w-100'>
          <div className='trd_hdlef1 d-flex align-items-center'>
            ...
            <div className='trd_bal2' style={{ width: "10%" }}>
              <h5 className={`fw-bold ${tickerData && (parseFloat(tickerData.c) > parseFloat(tickerData.b)) ? 'text-success' : 'text-danger'}`}>{tickerData && decimalRoundOff(((parseFloat(tickerData.c)+parseFloat(pairInfo.uprousdtpricechange)) * inrPrice), priceDecimal) || '0.0000'}</h5>
            </div>
            ...
            <ul className="d-flex flex-wrap gap-5 trd_vlis1">
              ...
              <li>
                <p className='text-muted'> 24h High </p>
                <p> {tickerData && decimalRoundOff(((parseFloat(tickerData.h) + parseFloat(pairInfo.uprousdtpricechange))  * inrPrice), priceDecimal) || '0.0000'} </p>
              </li>
              <li>
                <p className='text-muted'>
                  24h Low
                ...
                <p>
                  {tickerData && decimalRoundOff(((parseFloat(tickerData.l) + parseFloat(pairInfo.uprousdtpricechange)) * inrPrice), priceDecimal) || '0.0000'}
                </p>
              </li>
              <li>
                <p className='text-muted'>
