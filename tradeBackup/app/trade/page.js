...
const TradePage = async () => {
  ...
  const pairInfo1 = { pair: chartpair, streamPair: chartpair1, toCurrency: chartpair2[1], fromCurrency: chartpair2[0],uprousdtpricechange:pairInfo?.uprousdtpricechange }
