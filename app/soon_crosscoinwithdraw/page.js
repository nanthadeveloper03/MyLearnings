                            ...
                            <div className="cm_vhmid">
                                <div className="row justify-content-center">
                                    <div className="col-md-4 col-sm-6 col-10 cms_bk1">
                                      <h3 className="text-capitalize"> Cross-Coin <span className="pri_color">Withdrawal</span></h3>
                                        <img src="../assets/images/comingsoon/crosscoin.png" className="img-fluid" />
                                    </div>
                                </div>
                                ...
                                <div className="row justify-content-center mt-4">
                                    <div className="col-md-8 col-sm-8 col-10 cms_bk1">
                                        ...
                                        <p className="desc">
                                        Cross-Coin Withdrawal launches soon. Effortlessly manage and control your crypto assets with our new feature!
                                        </p>
