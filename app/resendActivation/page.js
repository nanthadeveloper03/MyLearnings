...
export default function forgotPassword() {
  ...
  const onSubmit = async (payload, step) => {
    try {
      ...
      const response = await apiRequest('/auth/resendlink', object);
      if (response?.status) {
        reset()
      }
    } catch (error) {
                ...
                <div className="flat-tabs col-md-4">
                  <div className="content-tab">
                    <div className="content-inner">
                      <h3 className="heading mb-4"> Resend Activation Link </h3>
                        ...
                        <div className="col-md-12">
                          <div className="block-text">
                            <p className="forgot_description">
                              ...
                              and we'll send you account activation link to activate your account.
                            </p>
                          </div>
                        </div>
                      </div>
                      <form className="authform" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {isLoading ?
                          ...
                          <button type="submit" className="btn-action"> Resend </button>
                        }
