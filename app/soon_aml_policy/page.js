                            ...
                            <div className="cm_vhmid">
                                <div className="row justify-content-center">
                                    <div className="col-md-4 col-sm-6 col-10 cms_bk1">
                                      <h3 className="text-capitalize">AML Policy</h3>
                                        <img src="../assets/images/comingsoon/policy.png" className="img-fluid" />
                                    </div>
                                </div>
                                ...
                                <div className="row justify-content-center mt-4">
                                    <div className="col-md-8 col-sm-8 col-10 cms_bk1">
                                        ...
                                        <p className="desc">
                                        Our AML Policy will highlight our commitment to preventing money laundering and ensuring a secure trading environment. Stay tuned!
                                        </p>
