                            ...
                            <div className="cm_vhmid">
                                <div className="row justify-content-center">
                                    <div className="col-md-4 col-sm-6 col-10 cms_bk1">
                                      <h3 className="text-capitalize"><span className="pri_color">Rewards</span> Hub</h3>
                                        <img src="../assets/images/comingsoon/rewards.png" className="img-fluid" />
                                    </div>
                                </div>
                                ...
                                <div className="row justify-content-center mt-4">
                                    <div className="col-md-8 col-sm-8 col-10 cms_bk1">
                                        ...
                                        <p className="desc">
                                        Rewards Hub launches on October 9th. Stay tuned for exciting rewards and opportunities!
                                        </p>
