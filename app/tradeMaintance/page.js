                        ...
                        <div className="cm_vhmid">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-8 col-sm-8 col-10 cms_bk1">
                                    <h3 className="text-capitalize"> Our <span>Trade</span> is under maintenance </h3>
                                    <p className="desc">Honestly its a Final Call!
We're pushing our app to the Playstore, and it will be published within 24 hours!
You may check, or we’ll update you immediately once its available
For the website, we’ll go live in 1-2 days
</p>
