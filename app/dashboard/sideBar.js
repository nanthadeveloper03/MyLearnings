  ...
  return (
    <div className="side-navbar">
      <ul className="sidebar-menu">
        <li className={`menuitem ${(pathname == '/dashboard/') ? 'active' : ''}`}>
          <Link href="/dashboard">
            <svg
              width="20"
              height="20"
        ...
        {/* Account Accordion */}
        <li className={`sidebar-menu-item ${openAccount ? "expanded" : ""}`}>
          <div
          ...
          <Collapse in={openAccount}>
            ...
            <li className={`innmenu ${(pathname == '/profile/') ? 'active' : ''}`}>
                <Link href="/profile/">User Profile</Link>
              </li>
              <li className={`innmenu ${(pathname == '/kyc-verification/kyc/') ? 'active' : ''}`}>
                <Link href="/kyc-verification/kyc/">Identity Verification</Link>
              </li>
              {/* <li>
                <Link href="/soon_settings/">Security</Link>
              </li> */}
            </ul>
          </Collapse>
        </li>
        ...
        {/* <li className={`sidebar-menu-item ${openOrders ? "expanded" : ""}`}>
          ...
          <Collapse in={openOrders}>
            <ul id="orders-collapse">
              <li>
                <Link href="/trade/?pair=UPRO-USDT">Spot</Link>
              </li>
              <li>
        ...
        <li className={`sidebar-menu-item ${openAssets ? "expanded" : ""}`}>
          ...
          <Collapse in={openAssets}>
            <ul id="Assets-collapse">
              <li className={`innmenu ${(pathname == '/spotassets/') ? 'active' : ''}`}>
                <Link href="/spotassets/">Spot</Link>
              </li>
              <li className={`innmenu ${(pathname == '/rewards/') ? 'active' : ''}`}>
                <Link href="/rewards/">Reward</Link>
              </li>
              <li className={`innmenu ${(pathname == '/referral/') ? 'active' : ''}`}>
        ...
        {/* <li  className={`${(pathname == '/referral/') ? 'active' : ''}`}>
          <Link href="/referral">
            <svg
              width="20"
              height="20"
        ...
        <li className={`menuitem ${(pathname == '/rewardshub/') ? 'active' : ''}`}>
        ...
        <li className={`menuitem ${(pathname == '/deposit/') ? 'active' : ''}`}>
          <Link href="/deposit/">
        ...
        <li className={`menuitem ${(pathname == '/withdraw/') ? 'active' : ''}`}>
          <Link href="/withdraw/">
        ...
        <li className={`menuitem ${(pathname == '/history/') ? 'active' : ''}`}>
          <Link href="/history/">
            <img src="/assets/images/dash_ico/history.png" className="img-fluid" />
            History
          </Link>
        </li>
        {/* <li className={`menuitem ${(pathname == '/soon_settings/') ? 'active' : ''}`}>
