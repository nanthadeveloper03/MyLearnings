                            ...
                            <div className="cm_vhmid">
                                <div className="row justify-content-center">
                                    <div className="col-md-4 col-sm-6 col-10 cms_bk1">
                                      <h3 className="text-capitalize">Convert</h3>
                                        <img src="../assets/images/comingsoon/swap.png" className="img-fluid" />
                                    </div>
                                </div>
                                ...
                                <div className="row justify-content-center mt-4">
                                    <div className="col-md-8 col-sm-8 col-10 cms_bk1">
                                        ...
                                        <p className="desc">
                                        Get ready! The Convert option will be live soon. Easily convert your assets!
                                       </p>
