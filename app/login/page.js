          ...
          <div className=" w-100 h-100">
            <div className="row h-100">
              ...
              <div className="col-md-12 d-flex flex-wrap align-items-center">
                ...
                <div className="flat-tabs col-md-5 col-xs-12">
                      ...
                      <form onSubmit={handleSubmit((data) => onSubmit(data, step))} className="authform">
                        ...
                        {step === 1 ?
                          <>
                            ...
                            <ReCAPTCHA key={recaptchaKey} sitekey={fetch.machineKey || ''} onChange={handleCaptchaChange} ref={recaptchaRef} theme={isTheme === 'is_dark' ? 'dark' : 'light'} />
