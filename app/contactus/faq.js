                    ...
                    <div className="cm_faq1">
                        <div className="flat-accordion">
                            <div className={isActive == 1 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleClick(1)}>
                                <h6 className="toggle-title finter fw600 black8">Is my personal information secure when contacting you?</h6>
                            ...
                            <div className={isActive == 2 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleClick(2)}>
                                <h6 className="toggle-title finter fw600 black8">How long does it take to get a response to my inquiry?
                            ...
                            <div className={isActive == 4 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleClick(4)}>
                                <h6 className="toggle-title finter fw600 black8">How can I contact Ultrapro Exchange for support?
                            ...
                            <div className={isActive == 5 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleClick(5)}>
                                <h6 className="toggle-title finter fw600 black8">Can I contact customer support outside of regular business hours?
